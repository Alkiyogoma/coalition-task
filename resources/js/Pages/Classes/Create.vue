<template>
  ...
  >
    <div class="flex items-center">
      ...
      <span class="ml-3">Add New School Class</span>
    </div>
    <span class="mr-3"> Go back  &RightArrow;</span>
      ...
      <form @submit.prevent="store">
        <div class="grid gap-6 mb-8 md:grid-cols-2">
          ...
          <multiple-input v-model="form.subject" :error="form.errors.subject" class="mb-5 pr-6 w-full lg:w-1/2" label="Slect Class Subjects">
            <option :value="null" />
          ...
          <loading-button :loading="form.processing" class="btn-indigo" type="submit">Create Class</loading-button>
        </div>
