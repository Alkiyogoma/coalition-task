          ...
          <div class="card">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-3">
                <a class="text-white text-capitalize ps-3">List of All Company Partners</a>
                  ...
                  <tbody v-if="!users.length">
                    <tr  v-for="user in users.data" :key="user.id">
                      ...
                      <td class="align-middle text-center">
                        ...
                        <Link :href="`/clients/partner/${ user.id }`" class="text-secondary font-weight-bold  " data-toggle="tooltip" data-original-title="Edit user">
                          <span class="badge badge-sm bg-gradient-success">Clients</span>
                        </Link>
