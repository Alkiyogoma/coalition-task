...
const graph = {
    ...
    title: {
        text: "Monthly Average School Collections",
    },
    subtitle: {
        text: "Genereted from School Collections",
    },
    xAxis: {
        categories: [
            "Jan",
...
const singlegraph = {
    ...
    title: {
        text: "Monthly Average Revenue Vs Expense",
    },
    subtitle: {
        text: "Generated from School Transactions",
    },
    xAxis: {
        categories: [
            "January",
    ...
    tooltip: {
        headerFormat:
            '<span style="font-size: 10px">{point.key} average collection</span><br/>',
        valueSuffix: "°F",
    },
    plotOptions: {
        column: {
    ...
    series: [
        {
            name: "Expense",
            data: [
                30.7, 31.5, 39, 49.8, 90.8, 70.2, 75.6, 40.8, 66.9, 55.9, 44.8,
                98.5,
            ],
        },
        //  {
        ...
        // },
        {
            name: "Revenue",
            data: [
                65.5, 67.1, 72.1, 11.2, 86.7, 90.1, 95.0, 90.0, 90.5, 84.2,
                12.3, 68.7,
            ],
        },
    ],
