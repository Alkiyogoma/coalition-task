    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header p-0 position-relative z-index-2">
            <h5 class="px-4" id="modal-title-exampleModalLong"> Record New Office expense </h5>
        </div>
        <div class="card-body">
                <form role="form text-left" method="post" action="/expenseadd">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary btn-lg btn-rounded w-50 mt-4 mb-0">Save expense</button>
                  </div> 
                </form>
          </div>
        </div>
