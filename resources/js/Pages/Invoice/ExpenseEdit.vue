  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
                <form role="form text-left" method="post" :action="`/expenseedit/${payment.uuid}/edit`">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="row">
                  ...
                  <div class="text-center">
                    <input type="hidden" :value="_token" name="_token" class="form-control">
                     <button type="submit" class="btn bg-gradient-primary btn-lg btn-rounded w-50 mt-4 mb-0">Update Expense</button>
                  </div> 
                </form>
          </div>
        </div>
