<template>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/payrollindex">
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/payrollpension">
            <div>
                <p
                    class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"
                >
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/deductionindex">
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/allowanceindex">
            <div>
                <p
                    class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"
                >
