<template>
            ...
            <div class="col-12 col-md-6 col-xl-4">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  <ul class="list-group">
                    <li class="list-group-item border-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp; {{ user.name }}</li>
                    <li class="list-group-item border-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; {{ user.phone }}</li>
                    <li class="list-group-item border-0 text-sm"><strong class="text-dark">Branch:</strong> &nbsp; {{ user.branch }}</li>
                    <li class="list-group-item border-0 text-sm"><strong class="text-dark">Account#:</strong> &nbsp;  {{ user.account }}</li>
                                                ...
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        ...
                                                        <p class="text-sm font-weight-normal text-secondary mb-0"><span
                                                                class="text-success">{{ install.start_date }}</span> <b> to </b> {{ install.end_date }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="input-group input-group-outline my-3">
                    <textarea name="body" required minlength="50" class="multisteps-form__textarea form-control" rows="5"  :placeholder="`Write a messages to remind ${user.name} his/her Outstanding Balance of ${user.remained} `" spellcheck="false"></textarea>
                </div>
          </div>
    ...
    <div class="modal fade" id="modal-notification" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
      <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title font-weight-normal" id="modal-title-notification"> Received Amount from <u>{{ user.name }}</u> </h5>
            <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
    ...
    <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
      <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title font-weight-normal" id="modal-title-exampleModalLong"> Add New Task Performed to <u>{{ user.name }}</u> </h5>
            <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
                ...
                <div class="input-group input-group-outline my-3">
                    <textarea name="about" required class="multisteps-form__textarea form-control" rows="3" :placeholder="`Write your activity performed to ${ user.name }.`" spellcheck="false"></textarea>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group input-group-outline my-3">
