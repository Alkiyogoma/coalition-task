<template>
    ...
    onclick="javascript:printDiv('printablediv')">
        <div class="flex items-center">
            ...
            <span> {{ contact.name }} Receipt</span>
        </div>
        <span>Add Profile &RightArrow;</span>
    </a>

    <div class="px-2 py-2 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800"  id="printablediv">
    <!-- <div class="invoice-box"> -->
        <table class="w-full whitespace-no-wrap" cellpadding="0" cellspacing="0">
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">

                <tr class="text-gray-700 dark:text-gray-400">
                    <th class="px-2 py-2"  align="left">
                        <img src="/images/school.png" style="max-width: 50%;" />
                    </th>
                ...
                <th class="px-2 py-2" align="left">
                    ...
                    Class - {{ contact.classes }} ({{ contact.section }}) <br />
                    Reg.  - {{ contact.roll }}<br />
                    Parent Phone - {{ contact.phone }}<br />
                </th>
                <th class="px-2 py-2" align="right">
                    Receipt #: {{ payment.receipt }}<br />
                    Payment date: {{ payment.date }}<br />
                    Received Date: {{ payment.add_date }}<br />
                    <!-- Due: February 1, 2015 -->
                </th>
                </tr>
              
                <tr class="text-gray-700 dark:text-gray-400">
                    <th colspan="2"  class="px-2 py-2">Received Payment for School Fees and Other Contribution</th>
                </tr>
                <tr class="text-gray-700 dark:text-gray-400">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-2 py-2">{{ payment.words }}</td>
                </tr>
                <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-2 py-2">Payment Method</td>
                    <td class="px-2 py-2">{{ payment.method }}</td>
                </tr>  <tr class="text-gray-700 dark:text-gray-400">
                    <th class="px-2 py-2" colspan="2">{{ payment.bank_account }} ({{ payment.bank_name }})</th>
                </tr>
                <!-- <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-2 py-2">Transaction ID</td>

                    <td class="px-2 py-2">{{ payment.id }}</td>
                </tr> -->

                <tr class="text-gray-700 dark:text-gray-400">
                    <th colspan="2"  class="px-2 py-2">Comments - {{ payment.note }}</th>
                </tr>
                <tr class="item last">
                ...
                <tr class="item last">
                    ...
                    <td class="px-2 py-2">{{ new_invoice.balance }}</td>
                </tr>

                <tr class="total">
                    <td class="px-2 py-2" align="center">  By  <u>{{ payment.user }}</u><br>
                        {{ payment.role }} 
                    </td>
    ...
    export default {
        ...
        methods: {
            ...
            printDownload () {
                ...
                document.getElementById('topnavheader').style.display = 'none';
                document.getElementById('topnav').style.display = 'none';
                document.getElementById('printcard').style.display = 'none';
                window.print(divElements);
                $('#topnav,#topnavheader,#topheader,#printcard').show();
