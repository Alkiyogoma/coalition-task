<template>
    ...
    >
        <div class="flex items-center">
            ...
            <span class="ml-3">School Transactions Dashboard</span>
        </div>
        <span class="mr-3"> New Revenue &RightArrow;</span>
    </a>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/revenue/index">
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/expense/index">
            <div>
                <p
                    class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"
                >
