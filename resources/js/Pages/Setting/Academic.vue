<template>
    ...
    >
        <div class="flex items-center">
            ...
            <span class="ml-2">School Academic Settings</span>
        </div>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
            ...
            <Link class="focus:text-indigo-500" href="/classes">
            <div>
                <p
...
>                    <u>Click to View</u>
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/gradeindex">
            <div>
                <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
>                    Grading
...
>                    <u>Click to View</u>
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/termindex">
            <div>
                <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
>                    Semesters
...
>                    <u>Click to View</u>
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/years">
            <div>
                <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
>                    Academic Year
...
>                    <u>Click to View</u>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/indexclasslevel">
            <div>
                <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
>                    Class Levels
...
>                    <u>Click to View</u>
        ...
        >
            ...
            <Link  class="focus:text-indigo-500" href="/view-subjects">
                <div>
                <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
>                    Subjects
