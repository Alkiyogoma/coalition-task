...
>                  <path
                ...
                <span class="ml-2">School Accounting Settings </span>
              </div>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/installments">
             <div>
                <p
...
>                    <u>Click to View</u>
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/bankaccountindex">
            <div>
                <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
>                    Bank Accounts
...
>                    <u>Click to View</u>
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/expense/category">
            <div>
                <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
>                    Charts of Accounts
...
>                    <u>Click to View</u>
        ...
        >
            ...
            <a class="focus:text-indigo-500" href="/groupgroup/index">
            <div>
                <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
>                    Account Groups
