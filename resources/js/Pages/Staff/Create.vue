            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                        <form @submit.prevent="store">
                          <div class="row">
                            <text-input v-model="form.name" :error="form.errors.first_name"
                                label="Staff name" />
                            ...
                            <div class="row">
                              <text-input onfocus="(this.type = 'date')" onblur="(this.type = 'text')" v-model="form.dob" :error="form.errors.dob" label="Date of Birth" />
                              <text-input  onfocus="(this.type = 'date')" onblur="(this.type = 'text')" v-model="form.jod" :error="form.errors.jod" label="Joining Date" />
                          </div>
                            <div class="row">
                          ...
                          <div class="row">
                            <select-input v-model="form.department_id" :error="form.errors.department_id"
                                ...
                                <option :value="null" />
                                <option v-for="organization in departments" :key="organization.id"
                            ...
                            <div
                                ...
                                <loading-button :loading="form.processing" class="btn-indigo" type="submit">Add Staff</loading-button>
                            </div>
                            </div>
