<template>
    ...
    >
      <div class="flex items-center">
        ...
        <span class="ml-3">History of {{ product }} Usages</span>
      </div>
      ...
      <table class="w-full whitespace-no-wrap" v-if="!items.length">
        ...
        <td class="px-2 py-2">
          <div class="flex items-center space-x-4 text-sm">
            <Link :href="`/viewstore/${item.uuid}/usage`" tabindex="-1" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="View">
              <svg
                ...
                <Link :href="`/deletestore/${item.uuid}/delete`" tabindex="-1" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Delete" onclick="confirm('Are you sure you want to delete this class?')"
>                  <svg
    ...
    watch: {
      form: {
        ...
        handler: throttle(function () {
          this.$inertia.get('/usage', pickBy(this.form), { preserveState: true })
        }, 150),
      },
    },
    methods: {
