<template>
                <br>
                <!-- CTA -->
                <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple" :href="`/contacts/${contact.uuid}/edit`"
                        ...
                        <div class="w-full overflow-x-auto">
                            ...
                            <tbody v-if="exams.length" class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800"           >
                                ...
                                <td class="px-2 py-2 text-xs">
                                    <span
                                    class="px-2 py-2 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"   >                                    {{ exam.average }}
                                    </span>
                                </td>
                                <td class="px-2 py-2 text-sm">
                                    {{ exam.date }}
...
>                Student Payment Reports
                ...
                <h4 class="mb-4 font-semibold text-gray-600 dark:text-gray-300">
                      ...
                      <div class="w-full overflow-x-auto">
                          ...
                          <tbody v-if="invoices.length"             class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800"         >
                              ...
                              <td class="px-2 py-2 text-xs">
                                  <span
                                  class="px-2 py-2 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100" >                                  {{ invoice.balance }}
                                  </span>
                              </td>
                              <td class="px-2 py-2 text-sm">
                ...
                <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody v-if="payments.length" class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800"           >
                                ...
                                <td class="px-2 py-2 text-xs">
                                    <span
                                    class="px-2 py-2 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"   >                                    {{ exam.amount }}
                                    </span>
                                </td>
                                <td class="px-2 py-2 text-xs">
                                    {{ exam.method }}
                ...
                <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody v-if="subjects.length" class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800"           >
                                ...
                                <td class="px-2 py-2 text-xs">
                                    <span
                                    class="px-2 py-2 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"   >                                    {{ exam.subject_type }}
                                    </span>
                                </td>
