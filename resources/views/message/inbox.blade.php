    ...
    <div class="d-flex justify-content-center">
        <nav>
            <ul class="pagination">
                ...
                <li class="page-item"><a class="page-link" href="http://127.0.0.1:8000/sent?page=2">2</a></li>
                <li class="page-item"><a class="page-link" href="http://127.0.0.1:8000/sent?page=3">3</a></li>
                <li class="page-item"><a class="page-link" href="http://127.0.0.1:8000/sent?page=2" rel="next" aria-label="Next &raquo;">&rsaquo;</a></li>
            </ul>
        </nav>
